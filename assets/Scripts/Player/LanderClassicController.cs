...
public class LanderClassicController : MonoBehaviour
{
    [Header("Flight")]
    [SerializeField] private float thrustImpulse = 6f;
    [SerializeField] private float minThrust = 5f;
    [SerializeField] private float maxThrust = 25f;
    [SerializeField] private float thrustTime = 10f;
    ...
    [Header("Limits")]
    [SerializeField] private float maxUpVelocity = 5f;
    [SerializeField] private float maxHorVelocity = 6f;
